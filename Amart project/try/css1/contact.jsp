...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><link href="css/bootstrap.min.css" rel="stylesheet" type="text/css" /><link href="css/style.css" rel="stylesheet" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><link href="css/respo.css" rel="stylesheet" /> 
         <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" /><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/css/bootstrap.min.css" />
  ...
  .prev, .next,.text {font-size: 11px}
    ...
    <body>
        ...
        <div class="form" method="post">
         <h2 class="title" style="text-transform: inherit;"><i class="fa fa-envelope" style="font-size:48px;color:red"></i>Connect to Us<br></h2> 
                        <span style="display:block; background-color:red width:100px;"> Drop a message to us we will get back to you</span>
                       
            
            <form action="contactus.jsp" class= forms>
             <input type="character " id="Name" name="Name"  placeholder="Name" required><br>
             <input type="email" id="Email_id" name="Email_id" placeholder="Email_id" required><br>
	       ...
	       <option  value="Bangalore">Bangalore</option>
	        <option value="Delhi">Delhi</option>
             <option value="Mumbai">Mumbai</option> 
                <option value="Hyderabad">Hyderabad</option></select><br>
            <textarea id="message" name="Message" placeholder="Message" ></textarea> <br>     
            <button type="submit" class="btn" onclick="##">Enquire Now</button></form>
        </div>
